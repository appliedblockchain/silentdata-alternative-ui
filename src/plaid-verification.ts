...
export const PRODUCTION_MRSIGNER: ArrayBuffer = hexToArrayBuffer(
    '463be517c1f292e2cf5a328d865f03e7cbcc4355e201484c39fedbd55534e849',
)

export const PRODUCTION_MRENCLAVES: ArrayBuffer[] = [
    'f279a7b3f8c804339c0bd9c159e2371c2c29f7040bce1f9731c09def887e0f8b',
].map(hexToArrayBuffer)

function commonName(cert: X509): string {
...
function validateCertificate(cert: X509, trustedChain: X509[]): boolean {
    let validated = false
...
export async function verifyRemoteAttestationReport(
    proof: Proof,
): Promise<boolean> {
